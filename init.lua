...
-- Execute Lua in vim
vim.keymap.set('n', '<leader>x', ':.lua<CR>', { desc = 'E[x]ecute line in Lua' })
vim.keymap.set('v', '<leader>x', ':lua<CR>', { desc = 'E[x]ecute selection in Lua' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      -- Can pass args to rg, for example --iglob test/ to ignore test directory
      -- Need to use quotes for pattern e.g. "grep_pattern" --iglob "test/"
      {
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        --
        defaults = {
          file_ignore_patterns = { '^.git/', '^.svn/', '/.git/', '/.svn/' },
          ...
          live_grep_args = {
            ...
            mappings = {
              i = {
                ...
                -- freeze the current list and start a fuzzy search in the froze list
